import { AppBar, Box, Button, Container, IconButton, SvgIcon, Toolbar, Typography, useScrollTrigger } from '@mui/material';
      ...
      <Toolbar component={Container} disableGutters>
        ...
        <Box component="nav" sx={{
          ...
          <IconButton color="primary" sx={{
            mx: .75
          }} href="https://medium.com/@moraes_victoria" target="_blank" aria-label="View profile on Medium">
            <SvgIcon>
          ...
          <IconButton color="primary" sx={{
            mx: .75
          }} href="https://github.com/victoriamorais" target="_blank" aria-label="View profile on GitHub">
            <SvgIcon>
          ...
          <IconButton color="primary" sx={{
            mx: .75
          }} href="https://www.linkedin.com/in/victoria-morais/" target="_blank" aria-label="View profile on LinkedIn">
            <SvgIcon>
